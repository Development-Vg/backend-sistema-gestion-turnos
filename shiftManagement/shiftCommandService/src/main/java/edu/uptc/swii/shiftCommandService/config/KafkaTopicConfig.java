package edu.uptc.swii.shiftCommandService.config;
//
...
//        configurations.put(TopicConfig.RETENTION_MS_CONFIG, "500"); // Tiempo de retencion de mensajes, defecto -1
...
//
//        NewTopic newTopic = TopicBuilder.name("turnos")
